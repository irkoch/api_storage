...
/**
 * @file
 * Contains Drupal\api_storage\ApiStorageEntityTypeInterface.
 */
...
/**
 * Provide an interface defining a api storage entity type.
 */
interface ApiStorageEntityTypeInterface extends ConfigEntityInterface {
  /**
  ...
  /**
   * Returns the field mappings of this endpoint entity type plugin.
   *
   * @return array
   *   An array associative array:
   *     - name: The source property.
   *     - definition: The destination field.
   */
