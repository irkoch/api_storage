...
class EndpointBundleHandler implements EndpointBundleHandlerInterface {
  ...
  /**
   * Constructs a new EndpointBundleHandler object.
   *
   ...
   *   The bundle plugin manager.
   */
  public function __construct(EntityTypeInterface $entity_type, ApiEndpointManager $plugin_manager) {
